...
$cmsPrivacyT1 = cms_page_get($pdo, 'privacy', [
    'hero_kicker' => 'Legal',
...
$siteBrandT1Privacy = site_brand_name($pdo);
if (!empty($cmsPrivacyT1['updated_at'])) {
    try {
        $lastUpdated = (new DateTimeImmutable((string) $cmsPrivacyT1['updated_at']))->format('F j, Y');
    } catch (Throwable $e) {
        /* keep default */
    }
}
...
<head>
  ...
  <title><?= h($cmsPrivacyT1['hero_title'] !== '' ? $cmsPrivacyT1['hero_title'] : 'Privacy Policy') ?> — <?= h($siteBrandT1Privacy) ?></title>
  <meta name="description" content="<?= h($cmsPrivacyT1['meta_description']) ?>">
    ...
    <section class="t1-static-hero t1-static-hero--compact" aria-labelledby="t1-privacy-title">
      <div class="container t1-static-hero-inner t1-static-hero-inner--compact">
        <div class="t1-static-hero-copy">
          <?php if (($cmsPrivacyT1['hero_kicker'] ?? '') !== ''): ?>
            <p class="t1-static-kicker script-accent"><?= h($cmsPrivacyT1['hero_kicker']) ?></p>
          <?php endif; ?>
          <h1 id="t1-privacy-title" class="t1-static-title"><?= h($cmsPrivacyT1['hero_title'] !== '' ? $cmsPrivacyT1['hero_title'] : 'Privacy Policy') ?></h1>
          <p class="t1-static-lead">
            <?= nl2br(h($cmsPrivacyT1['hero_lead'])) ?>
          </p>
        </div>
      </div>
    </section>
    ...
    <div class="container t1-static-wrap">
      ...
      <div class="t1-legal-layout">
        ...
        <article class="t1-legal-doc">
          ...
          <?php if (trim((string) $cmsPrivacyT1['body_html']) !== ''): ?>
            <div class="t1-legal-cms-body"><?= $cmsPrivacyT1['body_html'] ?></div>
          <?php else: ?>
