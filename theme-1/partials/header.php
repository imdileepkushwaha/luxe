...
if (function_exists('site_brand_name') && function_exists('db')) {
    try {
        $t1HeaderBrand = site_brand_name(db());
        $t1HeaderLogo = site_logo_path(db());
    } catch (Throwable $e) {
        $t1HeaderBrand = 'LUXE';
        $t1HeaderLogo = '';
    }
...
<header class="site-header">
  <div class="container header-inner">
    ...
    <a class="header-logo" href="index.php" aria-label="<?= h($t1HeaderBrand) ?> home">
      <?php if ($t1HeaderLogoUrl !== ''): ?>
        <img src="<?= h($t1HeaderLogoUrl) ?>" alt="<?= h($t1HeaderBrand) ?>" class="header-logo-img">
      <?php else: ?>
        ...
        <span class="logo-word"><?= h($t1HeaderBrand) ?></span>
      <?php endif; ?>
    </a>
...
<div class="container">
  <div class="subnav-strip">
    ...
    <a class="subnav-logo" href="index.php" aria-label="<?= h($t1HeaderBrand) ?> home">
      <?php if ($t1HeaderLogoUrl !== ''): ?>
        <img src="<?= h($t1HeaderLogoUrl) ?>" alt="<?= h($t1HeaderBrand) ?>" class="subnav-logo-img">
      <?php else: ?>
        <span class="logo-mark" aria-hidden="true"><span class="logo-stripe"></span><span class="logo-stripe"></span><span class="logo-stripe"></span></span>
        <span class="logo-word"><?= h($t1HeaderBrand) ?></span>
      <?php endif; ?>
