    ...
    <section class="profile-shell" aria-label="Address content">
      <aside class="profile-side">
        ...
        <ul class="profile-menu">
          ...
          <li><a href="address.php" class="is-active">Address</a></li>
          <li><a href="../profile.php?tab=wishlist">Wishlist</a></li>
          <li><a href="../profile.php?tab=reviews">Reviews</a></li>
          <li><a href="../profile.php?tab=settings">Change Password</a></li>
          <li><a href="../actions/logout.php?redirect=theme-1/index.php">Logout</a></li>
        </ul>
      </aside>
