...
$cmsAboutT2 = cms_page_get($pdo, 'about', [
...
$siteBrandT2About = site_brand_name($pdo);
?>
<!doctype html>
<html lang="en">
<head>
  ...
  <title><?= h($cmsAboutT2['hero_title'] !== '' ? $cmsAboutT2['hero_title'] : 'About Us') ?> — <?= h($siteBrandT2About) ?></title>
  <meta name="description" content="<?= h($cmsAboutT2['meta_description']) ?>">
    ...
    <section class="t1-static-hero" aria-labelledby="t1-about-title">
      <div class="container t1-static-hero-inner">
        <div class="t1-static-hero-copy">
          <?php if (($cmsAboutT2['hero_kicker'] ?? '') !== ''): ?>
            <p class="t1-static-kicker script-accent"><?= h($cmsAboutT2['hero_kicker']) ?></p>
          <?php endif; ?>
          <h1 id="t1-about-title" class="t1-static-title"><?= h($cmsAboutT2['hero_title'] !== '' ? $cmsAboutT2['hero_title'] : 'About Us') ?></h1>
          <p class="t1-static-lead">
            <?= nl2br(h($cmsAboutT2['hero_lead'])) ?>
          </p>
        ...
        <div class="t1-static-hero-visual t1-static-hero-visual--about" aria-hidden="true">
          <img src="<?= h(luxe_theme_asset('images/features-2.jpg')) ?>" alt="About Us">
        </div>
      </div>
    </section>
    ...
    <div class="container t1-static-wrap">
      ...
      <section class="t1-static-section">
        <div class="t1-static-grid-2">
          <div>
            <?php if (trim((string) $cmsAboutT2['body_html']) !== ''): ?>
              <div class="t1-static-cms-body"><?= $cmsAboutT2['body_html'] ?></div>
            <?php else: ?>
