...
/** @var string $activeNav dashboard|settings|users|orders|earnings|sellers|seller_kyc|seller_withdrawals|deletions|product_approvals|search|crm */
/** @var array $admin */
  ...
  <div class="admin-layout" id="adminLayout">
    <aside class="admin-sidebar" id="adminSidebar" aria-label="Main navigation">
      ...
      <nav class="admin-nav">
        ...
        <?php
        $crmTabRaw = (string) ($_GET['tab'] ?? '');
        $crmActiveTab = in_array($crmTabRaw, ['site_info','contact','about','faq','terms','privacy','return_policy','theme'], true) ? $crmTabRaw : 'site_info';
        $crmGroupOpen = $activeNav === 'crm';
        ?>
        <details class="admin-nav__group admin-nav__group--dropdown<?= $crmGroupOpen ? ' admin-nav__group--active' : '' ?>"<?= $crmGroupOpen ? ' open' : '' ?>>
          <summary class="admin-nav__parent admin-nav__parent--button" aria-haspopup="true">
            <svg width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M3 5a2 2 0 0 1 2-2h11a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" opacity=".4"></path><path fill="currentColor" d="M7 7.75a.75.75 0 0 0 0 1.5h7a.75.75 0 0 0 0-1.5zm0 3.5a.75.75 0 0 0 0 1.5h7a.75.75 0 0 0 0-1.5zm0 3.5a.75.75 0 0 0 0 1.5h4a.75.75 0 0 0 0-1.5zM19 5a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2v-2a4 4 0 0 0 0-8z"></path></svg>
            <span>CMS</span>
            <svg class="admin-nav__chevron" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="6 9 12 15 18 9"/></svg>
          </summary>
          <a class="admin-nav__sublink<?= $crmGroupOpen && $crmActiveTab === 'site_info' ? ' admin-nav__sublink--active' : '' ?>" href="crm.php?tab=site_info">Site Info</a>
          <a class="admin-nav__sublink<?= $crmGroupOpen && $crmActiveTab === 'contact' ? ' admin-nav__sublink--active' : '' ?>" href="crm.php?tab=contact">Contact Page</a>
          <a class="admin-nav__sublink<?= $crmGroupOpen && $crmActiveTab === 'about' ? ' admin-nav__sublink--active' : '' ?>" href="crm.php?tab=about">About Page</a>
          <a class="admin-nav__sublink<?= $crmGroupOpen && $crmActiveTab === 'faq' ? ' admin-nav__sublink--active' : '' ?>" href="crm.php?tab=faq">FAQ Page</a>
          <a class="admin-nav__sublink<?= $crmGroupOpen && $crmActiveTab === 'terms' ? ' admin-nav__sublink--active' : '' ?>" href="crm.php?tab=terms">Terms &amp; Conditions</a>
          <a class="admin-nav__sublink<?= $crmGroupOpen && $crmActiveTab === 'privacy' ? ' admin-nav__sublink--active' : '' ?>" href="crm.php?tab=privacy">Privacy Policy</a>
          <a class="admin-nav__sublink<?= $crmGroupOpen && $crmActiveTab === 'return_policy' ? ' admin-nav__sublink--active' : '' ?>" href="crm.php?tab=return_policy">Return Policy</a>
          <a class="admin-nav__sublink<?= $crmGroupOpen && $crmActiveTab === 'theme' ? ' admin-nav__sublink--active' : '' ?>" href="crm.php?tab=theme">Theme</a>
        </details>
          ...
          <div class="admin-apps-wrap">
            ...
            <div class="admin-apps-dropdown" role="menu" aria-label="Open applications">
              <div class="admin-apps-dropdown__inner">
                ...
                <a class="admin-apps-dropdown__item" role="menuitem" href="crm.php?tab=site_info"><span class="admin-apps-dropdown__icon" aria-hidden="true"><svg width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M3 5a2 2 0 0 1 2-2h11a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" opacity=".4"></path><path fill="currentColor" d="M7 7.75a.75.75 0 0 0 0 1.5h7a.75.75 0 0 0 0-1.5zm0 3.5a.75.75 0 0 0 0 1.5h7a.75.75 0 0 0 0-1.5zm0 3.5a.75.75 0 0 0 0 1.5h4a.75.75 0 0 0 0-1.5zM19 5a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2v-2a4 4 0 0 0 0-8z"></path></svg></span><span>CRM &amp; Pages</span></a>
