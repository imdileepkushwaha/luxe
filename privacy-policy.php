...
<body class="static-page index-page">
  ...
  <main>
    <section class="static-hero" aria-labelledby="static-privacy-title">
      <div class="container static-hero-inner">
        <div class="static-hero-copy">
          <p class="static-kicker">Data Protection</p>
          <h1 id="static-privacy-title" class="static-title">Privacy Policy</h1>
          <p class="static-lead">We are committed to protecting your personal data. This policy explains our practices regarding your information.</p>
        </div>
      </div>
    </section>
